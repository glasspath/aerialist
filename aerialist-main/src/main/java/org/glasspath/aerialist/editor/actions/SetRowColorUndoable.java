...
public class SetRowColorUndoable implements UndoableEdit {
	...
	public SetRowColorUndoable(TableView tableView, int row, int repeat, Color color, List<RowStyle> oldRowStyles) {
