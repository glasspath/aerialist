...
public class DeletePageUndoable extends DocumentEditorUndoable {

	private final PageView pageView;
	private final int index;

	public DeletePageUndoable(DocumentEditorPanel context, PageView pageView, int index) {
		super(context);
	...
	public String getPresentationName() {
		return AerialistResources.getString("DeletePage"); //$NON-NLS-1$
	}

	@Override
	public String getRedoPresentationName() {
		return AerialistResources.getString("RedoDeletePage"); //$NON-NLS-1$
	}

	@Override
	public String getUndoPresentationName() {
		return AerialistResources.getString("UndoDeletePage"); //$NON-NLS-1$
	}
