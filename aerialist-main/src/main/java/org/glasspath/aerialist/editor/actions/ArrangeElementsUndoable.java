...
public class ArrangeElementsUndoable extends DefaultEditorUndoable {
	...
	public String getPresentationName() {
		return AerialistResources.getString("ArrangeElements"); //$NON-NLS-1$
	}

	@Override
	public String getRedoPresentationName() {
		return AerialistResources.getString("RedoArrangeElements"); //$NON-NLS-1$
	}

	@Override
	public String getUndoPresentationName() {
		return AerialistResources.getString("UndoArrangeElements"); //$NON-NLS-1$
	}
