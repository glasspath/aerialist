...
public abstract class DocumentEditorContext extends EditorContext<DocumentEditorPanel> {
	...
	public boolean isGridDefaultVisible() {
		return gridDefaultVisible;
	}

	public void setGridDefaultVisible(boolean gridDefaultVisible) {
		this.gridDefaultVisible = gridDefaultVisible;
	}

	public boolean isGuidesDefaultVisible() {
		return guidesDefaultVisible;
	}
